...
if (!fs.existsSync(dbPath)) {
    fs.writeFileSync(dbPath, JSON.stringify({ warns: [], tickets: [], customCommands: [], welcomeSettings: [], statusSettings: [], invites: [], giveaways: [], ticketSettings: [], transcriptSettings: [], reviewSettings: [] }, null, 4));
}
